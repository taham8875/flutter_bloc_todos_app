...
import 'package:flutter_bloc_todos_app/edit_todo/bloc/edit_todo_bloc.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: status.isLoadingOrSuccess
            ? null
            : isNewTodo
                ? () => context.read<EditTodoBloc>().add(const EditTodoSubmitted(isUpdate: false))
                : () => context.read<EditTodoBloc>().add(const EditTodoSubmitted(isUpdate: true)),
